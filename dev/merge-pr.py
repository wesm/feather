...
FEATHER_HOME = os.path.abspath(__file__).rsplit("/", 2)[0]
PROJECT_NAME = 'feather'
print("FEATHER_HOME = " + FEATHER_HOME)
...
GITHUB_BASE = "https://github.com/wesm/" + PROJECT_NAME + "/pull"
GITHUB_API_BASE = "https://api.github.com/repos/wesm/" + PROJECT_NAME
